...
public class ITrus implements Signer{
	...
	//CVM Config
	private String cvmConfigFile = KjtConfig.cvmPath;
	//证书路径
	private String pfxFileName = KjtConfig.pfxPath;
	//证书访问密码
	private String keyPassword = KjtConfig.pfxKey;

	private String certFileName = KjtConfig.certPath;
